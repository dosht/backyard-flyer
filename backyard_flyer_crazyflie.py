...
class BackyardFlyer(Drone):
    ...
    def local_position_callback(self):
        ...
        if self.flight_state == States.TAKEOFF:
            ...
            print(f"local position: ({self.local_position[0]}, {self.local_position[1]}, {self.local_position[2]})")
    ...
    def calculate_box(self):
        ...
        # local_waypoints = [cp + [2.0, 0.0, 0.5], cp + [2.0, 2.0, 0.5], cp + [-2.0, -2.0, 0.5]]
        local_waypoints = [[
            cp + [1.0, 0.0, 0.5, 0.0],
            cp + [1.0, 1.0, 0.5, 0.0],
            cp + [0.0, 1.0, 0.5, 0.0],
    ...
    def waypoint_transition(self):
        print(f"waypoint transition: {self.all_waypoints}")
